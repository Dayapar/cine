<%-- 
    Document   : registrarSnacks
    Created on : 24/08/2020, 06:47:19 PM
    Author     : Mizaki
--%>
...
<html lang="es">
    <head>
        ...
        <title>CineDistrito | Registrar Snacks</title>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark py-lg-4" id="mainNav">
      <div class="container">
        ...
        <h1 class="site-heading d-none d-lg-block" style="color:white" align="center">
            <span class="site-heading-lower">Registrar Snacks</span>
        </h1>
   <div class="container">
            ...
            <div class="row ">
                <div class="col-sm-12 col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="idsnacks" name="idsnacks" placeholder="Codigo">
                    </div>
                    <br>
                    <div class="form-group">
                ...
                <a href="listarSnacks.jsp"><input type="button" value="Ver" class="btn btn-success"  OnClick="submit();"></a>
                </div>
            </div>
       </form>
        <%if (!request.getParameterMap().isEmpty()) {
          ...
          try{
            ...
            //response.sendRedirect("listaclientes.jsp");
                ...
                out.println("Cantidad ["+ request.getParameter("cantidad")+ "] <br>");
