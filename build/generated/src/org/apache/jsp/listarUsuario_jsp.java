...
public final class listarUsuario_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("        <title>CineDistrito | Usuario</title>\n");
      out.write("       \n");
      out.write("    <!-- Bootstrap -->\n");
      ...
      out.write("                    <th scope=\"col\">Documento de Identidad</th>\n");
 ...
 while (user.next()){ 
      ...
      out.write("                        <td>");
      out.print( user.getInt("idusuario") );
      out.write("</td>\n");
      out.write("                        <td>");
      out.print( user.getString("nombre") );
      out.write("</td>\n");
      out.write("                        <td>");
      out.print( user.getString("apellido") );
      out.write("</td>\n");
      out.write("                        <td>");
      out.print( user.getString("d_identificacion") );
      out.write("</td>\n");
      out.write("                        <td>");
      out.print( user.getInt("telefono") );
      out.write("</td>\n");
      out.write("                        <td>");
      out.print( user.getString("email") );
      out.write("</td>\n");
      out.write("                        <td>");
      out.print( user.getDate("f_nacimiento") );
      out.write("</td>\n");
      out.write("                        <td class=\"links\">\n");
      out.write("                            <a href=\"CargarUsuario?opc=edit&idx=");
      out.print( user.getInt("idusuario") );
      out.write("\">Editar</a>\n");
      out.write("                            <a href=\"CargarUsuario?opc=delete&idx=");
      out.print( user.getInt("idusuario") );
      out.write("\">Borrar</a>\n");
      out.write("                        </td>\n");
      out.write("                    </tr>\n");
      ...
      out.write("        </table>\n");
      out.write("                <br><br>\n");
      out.write("                <td colspan=\"5\" class=\"links\" align=\"center\"><a href=\"registrarUsuario.jsp\"><input type=\"button\" class=\"btn btn-success\" value=\"Añadir\" onclick=\"submit();\"></a></td>\n");
      out.write("                ");
      out.write("\n");
      out.write("            \n");
      out.write("        </div>\n");
