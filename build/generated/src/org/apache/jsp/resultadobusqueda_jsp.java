...
public final class resultadobusqueda_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("        <title>CineDistrito | Resultado</title>\n");
      out.write("       \n");
      out.write("    <!-- Bootstrap -->\n");
      ...
      out.write("            <span class=\"site-heading-lower\">Usuario</span>\n");
      out.write("        </h1>\n");
      out.write("        \n");
      out.write("        \n");
      out.write("    <div class=\"container\">\n");
      out.write("             \n");
      out.write("        <table  class=\"table table-striped table-dark mt-5\">\n");
      out.write("            \n");
      out.write("            <tr>\n");
      out.write("                <td>Codigo</td>\n");
      out.write("                <td>");
      out.print( ((Usuario)session.getAttribute("consultar")).getIdusuario());
      out.write(" </td>\n");
      out.write("            </tr> \n");
      out.write("            <tr>\n");
      out.write("                <td>Nombre </td>\n");
      out.write("                <td>");
      out.print( ((Usuario)session.getAttribute("consultar")).getNombre());
      out.write("</td>\n");
      out.write("            </tr> \n");
      out.write("            <tr>\n");
      out.write("                <td>Apellido</td>\n");
      out.write("                <td>");
      out.print( ((Usuario)session.getAttribute("consultar")).getApellido());
      out.write("</td>\n");
      out.write("            </tr>\n");
      out.write("            <tr>\n");
      out.write("                <td>Documento de identidad</td>\n");
      out.write("                <td>");
      out.print( ((Usuario)session.getAttribute("consultar")).getD_identificacion());
      out.write("</td>\n");
      out.write("            </tr>   \n");
      out.write("            <tr>\n");
      out.write("                <td>Telefono</td>\n");
      out.write("                <td>");
      out.print( ((Usuario)session.getAttribute("consultar")).getTelefono());
      out.write("</td>\n");
      out.write("            </tr>\n");
      out.write("            <tr>\n");
      out.write("                <td>Email</td>\n");
      out.write("                <td>");
      out.print( ((Usuario)session.getAttribute("consultar")).getEmail());
      out.write("</td>\n");
      out.write("            </tr>      \n");
      out.write("            <tr>\n");
      out.write("                <td>Fecha de Nacimiento</td>\n");
      out.write("                <td>");
      out.print( ((Usuario)session.getAttribute("consultar")).getF_nacimiento());
      out.write("</td>\n");
      out.write("            </tr>      \n");
      out.write("        </table>\n");
      out.write("    </div>\n");
