<%-- 
    Document   : listarSnacks
    Created on : 24/08/2020, 06:26:25 PM
    Author     : Mizaki
--%>
...
<html lang="es">
    <head>
        ...
        <title>CineDistrito | Snacks</title>
  ...
  <!-- Menu acceso -->
    ...
    <nav class="navbar navbar-expand-lg navbar-dark py-lg-4" id="mainNav">
      <div class="container">
        ...
        <h1 class="site-heading d-none d-lg-block" style="color:white" align="center">
            <span class="site-heading-lower">Snacks</span>
        </h1>
    ...
    <table class="mt-5 table table-responsive-md  table-striped table-dark">
            <tr>
                ...
                <% while (snacks.next()){ %>
                    <tr align="center">
                        <td><%= snacks.getInt("idsnacks") %></td>
                        <td><%= snacks.getString("nombre") %></td>
                        <td><%= snacks.getInt("precio") %></td>
                        <td><%= snacks.getInt("cantidad") %></td>
                        <td class="links">
                            <a href="CargarSnacks?opc=edit&idx=<%= snacks.getInt("idsnacks") %>">Editar</a>
                            <a href="CargarSnacks?opc=delete&idx=<%= snacks.getInt("idsnacks") %>">Borrar</a>
                        </td>
                    </tr>
                <% }%>
                <tr>
                ...
                <br><br>
                <td colspan="5" class="links" align="center"><a href="registrarSnacks.jsp"><input type="button" class="btn btn-success" value="Añadir" onclick="submit();"></a></td>
