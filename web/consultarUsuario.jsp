<%-- 
    ...
    Created on : 25/08/2020, 04:44:41 PM
    Author     : Mizaki
--%>
...
<html lang="es">
    <head>
        ...
        <title>CineDistrito | Consultar Usuario</title>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark py-lg-4" id="mainNav">
      <div class="container">
        ...
        <h1 class="site-heading d-none d-lg-block" style="color:white" align="center">
            <span class="site-heading-lower">Consultar usuario</span>
        </h1>
        
         <div class="container">
    <form id="frmActualizarBlog" action="ConsultarUsuario" method="POST">
        <br><br>
        <table  class="table table-striped table-dark">
            <tr>
                <td>ID Usuario</td>
                <td><input type="text" id="idusuario" name="idusuario" value=""></td>
            </tr>
            <%--   <tr>
